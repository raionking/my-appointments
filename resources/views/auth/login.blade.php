              ...
              <form method="POST" action=" {{ route('login')}} " role="form">
                ...
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <input name="email" id="email" class="form-control" placeholder="Email" type="email" value="{{ old('email') }}" required autofocus>
                    @if ($errors->has('email'))
                ...
                <div class="custom-control custom-control-alternative custom-checkbox">
                  <input name="remember" 
                    ...
                    customCheckLogin" type="checkbox" {{ old('remember') ? 'checked' : '' }}>
